...
class _SolitareState extends State<Solitare> {
  ...
  bool cardIsPlaceable(PlayingCard newCard) {
    ...
    //Checking suit
    if (changingCard[0].suit == Suit.diamonds ||
        changingCard[0].suit == Suit.hearts) {
  ...
  bool isCardPutAtop(PlayingCard? topCard, Suit defaultSuit) {
    ...
    if (topCard == null &&
        defaultSuit == changingCard[0].suit &&
        changingCard[0].value == CardValue.ace) {
      return true;
    }
  ...
  void moveCardOnTop(
      PlayingCard? topCard, Suit boxSuit, List<PlayingCard> stack) {
      ...
      if (playingColumns[currentIndex].isNotEmpty) {
        ...
        if (currentIndex > 6) {
          ...
          //Checks to see if there is one or multiple cards
            ...
            cardIndex == playingColumns[currentIndex].length - 1) {
          changingCard.add(playingColumns[currentIndex].last);

          //This handles multiple cards selected
        } else {
          for (int i = cardIndex!;
              i < playingColumns[currentIndex].length;
              i++) {
  ...
  */
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text('Solitare'), actions: [
          IconButton(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            if (changingCard.isNotEmpty) {
                                              moveCardOnTop(
                                                  playingColumns[7].isNotEmpty
                                                      ? playingColumns[7].last
                                                      : null,
                                                  Suit.diamonds,
                                                  playingColumns[7]);
                                            } else {
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            if (changingCard.isNotEmpty) {
                                              moveCardOnTop(
                                                  playingColumns[8].isNotEmpty
                                                      ? playingColumns[8].last
                                                      : null,
                                                  Suit.hearts,
                                                  playingColumns[8]);
                                            } else {
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            if (changingCard.isNotEmpty) {
                                              moveCardOnTop(
                                                  playingColumns[9].isNotEmpty
                                                      ? playingColumns[9].last
                                                      : null,
                                                  Suit.spades,
                                                  playingColumns[9]);
                                            } else {
                                        ...
                                        GestureDetector(
                                          onTap: () {
                                            if (changingCard.isNotEmpty) {
                                              moveCardOnTop(
                                                  playingColumns[10].isNotEmpty
                                                      ? playingColumns[10].last
                                                      : null,
                                                  Suit.clubs,
                                                  playingColumns[10]);
                                            } else {
